# -*- coding: utf-8 -*-
"""
Created on Mon Dec 18 13:33:42 2017
...
def areatriangle(b,h):
    """ Computes the area of a triangle of the given base ahd height """
    area = .5*b*h
#    print("The area of a circle of radius",radius,"is", area)
...
#    print("The Fahrenheit temperature",temp,"is equivalent to",newTemp,end='')
#    print(" degrees Celsius")
    print"The Celsius temperature",temp,"is equivalent to",newTemp,
...
#    lname = input("Enter your last name: ")
    ...
    state = raw_input("Enter the State you live in: ")
    fullname = fname + " " + lname
    you_live = city + ", " + state
    print"Your name is:", fullname
